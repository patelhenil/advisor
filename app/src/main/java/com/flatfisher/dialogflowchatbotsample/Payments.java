...
public class Payments<PieChartActivity> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linkInitializeOptions.put("key", "183be82ab9debfa3150c1f5a75c021");
                       ...
                       String categories =  linkData.get("transactions[categories]");
                        ...
                        pie.setOnClickListener(new ListenersInterface.OnClickListener(new String[]{"x", "value"}) {
                            ...
                            public void onClick(Event event) {
                                Toast.makeText(Payments.this, event.getData().get("x") + ":" + event.getData().get("value"), Toast.LENGTH_SHORT).show();
                            }
                        });
